...
- The enabled interest form collects adult/parent name, email, phone, selected training groups and an optional comment, with consent for opening updates by email and phone. It does not book a class or collect payment.
- Successful submission opens a dedicated confirmation page with opening-update guidance, a first-session-free reminder and the academy’s supplied Instagram and TikTok links.
